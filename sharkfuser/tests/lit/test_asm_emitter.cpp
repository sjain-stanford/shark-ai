...
void test_getTensorTypeAsm() {
  ...
  std::cout << t1.getTensorTypeAsm(/*isValueTensor=*/true) << std::endl;

  // CHECK:  !torch.tensor<[2,3],f32>
  std::cout << t1.getTensorTypeAsm(/*isValueTensor=*/false) << std::endl;
  ...
  std::cout << t2.getTensorTypeAsm(/*isValueTensor=*/true) << std::endl;

  // CHECK:  !torch.tensor<[2,4,3],f32>
  std::cout << t2.getTensorTypeAsm(/*isValueTensor=*/false) << std::endl;
}
