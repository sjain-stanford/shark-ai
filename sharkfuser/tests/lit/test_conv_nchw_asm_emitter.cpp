...
int main() {
  ...
  graph->setName("conv_nchw_asm_emitter_test");
  ...
  // clang-format off
  // CHECK:   module @module {
  // CHECK:     func.func @main(%result_: !torch.tensor<[16,256,64,32],f32>, %arg0_image: !torch.vtensor<[16,128,64,32],f32>, %arg1_filter: !torch.vtensor<[256,128,1,1],f32>) attributes {torch.assume_strict_symbolic_shapes} {
  ...
  // CHECK:       torch.overwrite.tensor.contents %result overwrites %result_ : !torch.vtensor<[16,256,64,32],f32>, !torch.tensor<[16,256,64,32],f32>
  // CHECK:       return
  // CHECK:     }
  // CHECK:   }
  // clang-format on
