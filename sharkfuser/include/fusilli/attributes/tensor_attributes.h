...
inline std::vector<int64_t> getChannelsFirstStrideOrder(int numDims) {
...
inline std::vector<int64_t> getChannelsLastStrideOrder(int numDims) {
  std::vector<int64_t> strideOrder(numDims);
...
generateStrideFromDim(const std::vector<int64_t> &dim,
  ...
  std::vector<std::pair<int64_t, int64_t>> idxToDimInStrideOrder(numDims);
